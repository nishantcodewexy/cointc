                                            ...
                                            <div className="col-md-6">
                                                <div className="btc-right mt-3">
                                                    ...
                                                    <div className="second-bn mt-3 text-secondary">
                                                        ...
                                                        <div className="input-group mb-3">
                                                            <input type="text" className="form-control" placeholder="0x8b4db4e2025a13428a231131c890ca73dcdce" aria-label="Recipient's username" aria-describedby="basic-addon2"/>
                                                            <div className="input-group-append">
                                                                <span className="input-group-text text-white" id="basic-addon2"></span>
                                                            </div>
                                                        </div>
                                                    </div>
