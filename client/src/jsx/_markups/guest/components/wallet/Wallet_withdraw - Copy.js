                                                ...
                                                <div class="btc-right mt-3">
                                                    ...
                                                    <div class="second-bn mt-3 text-secondary">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0x8b4db4e2025a13428a231131c890ca73dcdce"/>
                                                            <div class="input-group-append">
                                                                <span class="input-group-text text-white" id="basic-addon2">@example</span>
                                                            </div>
                                                        </div>
                                                    </div>
