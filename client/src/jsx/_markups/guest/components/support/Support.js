          ...
          <div className="container">
            <div className="customer-center">
              ...
              <p className="customer-center-content font-weight-bold mb-0">
                [안내] Coin TC, 알고란 채널과 함께 ‘Coin TC의 거의 모든 것’ 영상
                공개
              </p>
              <hr className="mt-0 mb-4" />
              <p className="customer-center-content font-weight-bold mb-0">
                [안내]비기너를 위한 'Coin TC 앱 사용설명서' 영상 공개
              </p>
              <hr className="m-0" />
            </div>
          </div>
                ...
                <div className="col col-sm-12 col-md-4 my-text">
                  ...
                  <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                      ...
                      >
                        {" "}
                        원화 마켓, BTC 마켓, USDT 마켓이 어떻게 다른가요?{" "}
                      </a>
                    </li>
                    <li className="nav-item">
                      <a
