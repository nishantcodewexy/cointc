  ...
  return (
    <>
      <Helmet>
        ...
        <script
          defer
          src="app-assets/js/scripts/configs/vertical-menu-dark.js"
        ></script>
        <script defer src="app-assets/js/core/app-menu.js"></script>
        <script defer src="app-assets/js/core/app.js"></script>
        <script defer src="app-assets/js/scripts/components.js"></script>
        <script defer src="app-assets/js/scripts/footer.js"></script>
        {/* <!-- END: Theme JS--> */}
                              ...
                              <li className="widget-todo-item">
                                <div className="widget-todo-title-wrapper d-flex justify-content-between align-items-center mb-50">
                                  <div className="widget-todo-title-area d-flex align-items-center">
                                    ...
                                    <span className="widget-todo-title ml-50">
                                      Add Calendar page, source and credit page
                                      in documentation
                                    </span>
                                  </div>
                                  <div className="widget-todo-item-action d-flex align-items-center">
